...
import com.app.easyleasy.dataclasses.generics.TAGenericResponse
...
interface NetworkService {
 ...
 @POST("subscription_purchase")
    @FormUrlEncoded
    fun callBuySubscription(@FieldMap map: HashMap<String, String>): Single<TAListResponse<LoginResponse>>
}