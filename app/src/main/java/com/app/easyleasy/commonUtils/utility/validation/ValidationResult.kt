package com.app.easyleasy.commonUtils.utility.validation
 ...
 * These types are defined in [com.app.easyleasy.utility.validation.ValidationResult]
 *
 * @param failedViewId Int? This is the id of view, for which validation is failed and need to focus on that view.
 *
 * @return ValidationResult
 */
fun createValidationResult(failType: Int?= null, failedViewId: Int? = null): com.app.easyleasy.dataclasses.ValidationResult? {
