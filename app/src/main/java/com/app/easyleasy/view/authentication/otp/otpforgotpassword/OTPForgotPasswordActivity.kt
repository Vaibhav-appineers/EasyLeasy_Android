package com.app.easyleasy.view.authentication.otp.otpforgotpassword
...
import com.app.easyleasy.commonUtils.common.Toaster.show
import com.app.easyleasy.commonUtils.utility.IConstants
import com.app.easyleasy.dagger.components.ActivityComponent
import com.app.easyleasy.databinding.ActivityOtpForgotPasswordBinding
...
import com.app.easyleasy.viewModel.OTPForgotPasswordViewModel
            ...
            if (response.settings?.isSuccess == true) {
                ...
                if (!response.data.isNullOrEmpty()) {
                    ...
                    dataBinding!!.apply {
                        ...
                        enableRetry = this@OTPForgotPasswordActivity.viewModel.getEnableRetrySettings()
                    }
                } else {
                    MSCGenerator.addAction(
                        GenConstants.ENTITY_APP,
