package com.app.easyleasy.application
...
import com.app.easyleasy.api.network.InternetAvailabilityChecker
import com.app.easyleasy.commonUtils.common.LoadingDialog
import com.app.easyleasy.commonUtils.utility.IConstants
import com.app.easyleasy.dagger.components.ApplicationComponent
import com.app.easyleasy.dagger.components.DaggerApplicationComponent
import com.app.easyleasy.dagger.modules.ApplicationModule
import com.app.easyleasy.db.AppPrefrrences
...
import com.app.easyleasy.scheduler.ExportLogService
...
class AppineersApplication : MultiDexApplication(), Application.ActivityLifecycleCallbacks {
        ...
        InterstitialAd.load(
            ...
            object : InterstitialAdLoadCallback() {
                override fun onAdFailedToLoad(adError: LoadAdError) {
                    ...
                    Log.d("MainApplication", "with error $error")
                ...
                override fun onAdLoaded(interstitialAd: InterstitialAd) {
                    ...
                    Log.d("MainApplication", "onAdLoaded: Ad successfully loaded.")
    ...
    fun initMoPubSDK(appInDevelopment: Boolean) {
        ...
        if (moPubAdUnitId.isNullOrEmpty()) {
            moPubAdUnitId = getString(R.string.mopub_banner_unit_id_test)
            logger.dumpCustomEvent(
                "MoPub SDK",
